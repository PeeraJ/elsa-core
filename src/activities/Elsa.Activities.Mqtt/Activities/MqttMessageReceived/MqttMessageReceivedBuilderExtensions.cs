...
namespace Elsa.Activities.Mqtt
{
    public static class MqttMessageReceivedBuilderExtensions
    {
        ...
        public static IActivityBuilder MessageQueueReceived<T>(this IBuilder builder, string topic, string host, int port, string username, string password, MqttQualityOfService qos, [CallerLineNumber] int lineNumber = default, [CallerFilePath] string? sourceFile = default) =>
